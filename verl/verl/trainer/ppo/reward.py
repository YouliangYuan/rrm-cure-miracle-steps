...
def load_reward_manager(config, tokenizer, num_examine, **reward_kwargs):
    ...
    try:
        return reward_manager_cls(
            ...
            tinyv_setup=config.reward_model.tinyv_setup,
            tinyv_weight=config.reward_model.tinyv_weight,
           **reward_kwargs,
        )
    except Exception as e:
        print(e)
        print("#"*50, '\nWithout tinyv_setup and tinyv_weight. We do not apply LLM verifier')
        return reward_manager_cls(
            tokenizer=tokenizer,
            num_examine=num_examine,
            compute_score=final_compute_score,
