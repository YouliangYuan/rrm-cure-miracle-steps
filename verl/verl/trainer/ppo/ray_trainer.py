...
class RayPPOTrainer:
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            ground_truth = [data_item.non_tensor_batch["reward_model"]["ground_truth"] for data_item in
                                            test_batch]
        ...
        print("✨✨✨CASE 1 \n\n### USER:\n{}\n\n### ASSISTANT:\n{}\n\n### SCORE: {}\n\n".format(sample_inputs[0], sample_outputs[0], sample_scores[0]))

        print("✨✨✨ CASE 2 \n\n### USER:\n{}\n\n### ASSISTANT:\n{}\n\n### SCORE: {}".format(sample_inputs[1], sample_outputs[1], sample_scores[1]))

        # dump generations
        val_data_dir = self.config.trainer.get("validation_data_dir", None)
        if val_data_dir:
            val_data_dir = os.path.join(
                val_data_dir, f"global_step_{self.global_steps}"
            )
    ...
    def fit(self):
        ...
        if self.val_reward_fn is not None and self.config.trainer.get("val_before_train", True): #TODO  改回来
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    print(f"rollout time cost: {execution_time:.2f} seconds")
                    ...
                    end_time = time.time()
                    execution_time = end_time - start_time
                    print(f"compute reward time cost: {execution_time:.2f} seconds")
                    ...
                    end_time = time.time()
                    execution_time = end_time - start_time
                    print(f"compute reference log prob time cost: {execution_time:.2f} seconds")
                    ...
                    end_time = time.time()
                    execution_time = end_time - start_time
                    print(f"compute value time cost: {execution_time:.2f} seconds")
                    ...
                    end_time = time.time()
                    execution_time = end_time - start_time
                    print(f"update critic and actor time cost: {execution_time:.2f} seconds")
                    # validate
                    if (
