...
def default_compute_score(data_source, solution_str, ground_truth, extra_info=None, tinyv_setup=None, tinyv_weight=None):
    # print("Computing default reward score")
    if data_source == 'openai/gsm8k':
        from . import gsm8k
        res = gsm8k.compute_score(solution_str, ground_truth)
    elif data_source.lower().strip()=='grade':
    ...
    elif data_source.lower().strip()=='math':
        from . import math
